...
import * as repoModule from '../../../../../driven/persistence/typeorm/payment/find-payment-all-repository/make-find-payment-all-repository'
import * as useCaseModule from '../../../../../../core/application/use-case/payment/find-payment-all/make-find-payment-all-use-case'
