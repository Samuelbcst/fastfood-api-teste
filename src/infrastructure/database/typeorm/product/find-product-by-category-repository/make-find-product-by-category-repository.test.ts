...
describe('makeFindProductByCategoryRepository', () => {
  ...
  it('should initialize dataSource and return a FindProductByCategoryTypeORMRepository', async () => {
    ...
    expect(repo).toBeInstanceOf(FindProductByCategoryTypeORMRepository)
  })
})
